...
setwd("~/Desktop/merge-seq analysis/luicell")
...
load('GSE161936_Lui_Nguyen_Seuratobjects.RData')
pfc_cell=Fig1Rbp4
...
FeaturePlot(pfc_retro, features = c('Npr3','Cav_PAG'),reduction = "tsne")
dev.off()

pdf('Fig3Rbp4retro vln nrip3.pdf')
VlnPlot(object = pfc_retro, features = 'Npr3')
dev.off()

p1=FeaturePlot(pfc_retro, features = c('Npr3'),reduction = "tsne")

p2=DimPlot(pfc_retro)
p1+p2
