...
for x in sample_trials:
        df = pd.read_csv('./swapping_results/fig6_var100_LH_valid_swapping_%d_1000cells.csv' % (x))
        ...
        metrics_data.to_csv(f"./LH_results_swapping_1000cells/LH_var_model_results_genes_metrics_{x}.csv", index=False)
