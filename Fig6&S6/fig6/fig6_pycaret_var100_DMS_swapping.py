...
for x in sample_trials:
        df = pd.read_csv('./swapping_results/fig6_var100_DMS_valid_swapping_%d_1000cells.csv' % (x))
        AUC = []
        Accuracy = []
        Recall = []
        Prec = []
        ...
        metrics_data.to_csv(f"./DMS_results_swapping_1000cells/DMS_var_model_results_genes_metrics_{x}.csv", index=False)
