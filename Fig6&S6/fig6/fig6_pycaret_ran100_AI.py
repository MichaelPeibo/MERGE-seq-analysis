...
for x in sample_trials:
        df = pd.read_csv('./sampling_results/ran100_AI_valid_binary_normdata_1000cells_%d.csv' % (x))
        AUC = []
        Accuracy = []
        Recall = []
        Prec = []
        ...
        metrics_data.to_csv(f"./AI_results_ran_1000cells/AI_ran_model_results_genes_metrics_{x}.csv", index=False)
