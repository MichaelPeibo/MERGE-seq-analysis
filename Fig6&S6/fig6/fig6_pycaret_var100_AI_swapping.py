...
for x in sample_trials:
        df = pd.read_csv('./sampling_results/fig6_var100_AI_valid_swapping_%d_1000cells.csv' % (x))
        AUC = []
        Accuracy = []
        Recall = []
        Prec = []
        ...
        metrics_data.to_csv(f"./AI_results_swapping_1000cells/AI_var_model_results_genes_metrics_{x}.csv", index=False)
