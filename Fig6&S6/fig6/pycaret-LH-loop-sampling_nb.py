...
for x in sample_trials:
        df = pd.read_csv('.//swapping_results/fig6_var100_LH_valid_swapping_%d.csv' % (x))
        ...
        metrics_data.to_csv(f"./lh_results_nb/LH_var_model_results_{n}_genes_metrics_{x}.csv", index=False)
