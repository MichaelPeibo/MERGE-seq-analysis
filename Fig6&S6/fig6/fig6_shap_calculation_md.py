...
df=pd.read_csv('./shap_results/fig6_var100_MD_valid_binary_normdata_allcells.csv')
...
np.save("./shap_results/fig6_md_shap_values_1500cells.npy", shap_values)
shap.summary_plot(shap_values, sub_sampled_test_data,show=False)
plt.savefig("./shap_results/fig6_md var shap plot nb 1500cells .pdf",dpi=1000)