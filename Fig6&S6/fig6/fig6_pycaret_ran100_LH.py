...
for x in sample_trials:
        df = pd.read_csv('./sampling_results/ran100_LH_valid_binary_normdata_1000cells_%d.csv' % (x))
        ...
        metrics_data.to_csv(f"./LH_results_ran_1000cells/LH_ran_model_results_genes_metrics_{x}.csv", index=False)
