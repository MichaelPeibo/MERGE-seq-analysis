...
for x in sample_trials:
        df = pd.read_csv('./sampling_results/ran100_BLA_valid_binary_normdata_1000cells_%d.csv' % (x))
        AUC = []
        Accuracy = []
        Recall = []
        Prec = []
        ...
        metrics_data.to_csv(f"./BLA_results_ran_1000cells/BLA_ran_model_results_genes_metrics_{x}.csv", index=False)
