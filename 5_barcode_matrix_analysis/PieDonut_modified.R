PieDonut_modified=function(data,mapping,center_label,
        ...
        mainCol=c('#1f77b4', '#8c564b', '#17becf')
        ...
        if(!is.null(donuts)){
                if(i %in% c(1,2,5)) {subColor=c('#7fc97f', '#beaed4', '#fdc086', '#386cb0', '#f0027f', '#bf5b17','#666666')
                } else {subColor=c('#7fc97f', '#beaed4', '#fdc086', '#f0027f', '#bf5b17','#666666')}
